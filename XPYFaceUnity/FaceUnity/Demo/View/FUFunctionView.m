...
- (UILabel *)fuTitleLabel {
    if (!_fuTitleLabel) {
        _fuTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-10, CGRectGetWidth(self.frame) + 2, CGRectGetWidth(self.frame) + 20, CGRectGetHeight(self.frame) - CGRectGetWidth(self.frame) - 2)];
